// array for hand options
const options = ["rock", "paper", "scissor"];
let score = {
  you: 0,
  computer: 0
};
// colors of result messages
...
// Function for comparing user/computer choice
function compare(player, computer) {
  ...
  if (player == computer) {
    ...
    // player loses with paper < scissor
    ...
    // player loses with scissor < rock
    ...
    // player wins with scissor > paper
